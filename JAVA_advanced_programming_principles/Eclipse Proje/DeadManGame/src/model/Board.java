...
public class Board {
	...
	/**
	 * Varaendert den Wert eines Elementes im Matrix zum "value"
	 * @param i row
	 * @param j column
	 * @param value
	 */
	...
	/**
	 * Liefert den Wert an den gegebenen Koordinaten
	 * @param i row
	 * @param j column
	 * @return int
	 */
	...
	/**
	 * Toggelt einen Wert der Matrix (aus 1 wird 0 und vice-versa)
	 * @param i row 
	 * @param j column
	 */
