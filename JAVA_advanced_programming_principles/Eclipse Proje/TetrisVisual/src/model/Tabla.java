...
public class Tabla {
	int[][] tabla;
	Map<List<Integer>,Piesa> pieseList = new HashMap<>();
	int sizeX;
	...
	public Map<List<Integer>, Piesa> getPieseList() {
		return pieseList;
	}
	public void setPieseList(Map<List<Integer>, Piesa> pieseList) {
